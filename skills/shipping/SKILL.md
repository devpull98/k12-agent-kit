...
# Steps
1. Chạy pre-launch checklist: code quality (test/build/lint pass, không console.log debug), security (theo rule security-baseline), performance cơ bản, infra (env var, migration, health check).
2. Nếu feature có rủi ro/chưa hoàn thiện 100%, bọc bằng feature flag — deploy code OFF trước, bật dần sau.
