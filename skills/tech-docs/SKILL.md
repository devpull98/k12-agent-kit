...
3. **Thiết kế DB changes** (nếu cần):
   ...
   - Migration approach (forward only, không breaking change nếu có thể) — migration nhiều bước / rủi ro cao: lập kế hoạch riêng theo `templates/migration-plan-template.md`
