...
4. Lưu spec (stable truth) vào `docs/specs/modules/<module>/<spec>.md` và thêm entry vào `docs/specs/modules/<module>/_index.md`. Tạo work package `docs/work/<KEY>-<slug>/_context.md` (từ `templates/_context.template.md`) với Spec anchor trỏ về file spec vừa lưu. Commit. Xem `rules/_global/doc-scoping.mdc`.
